...
import {APIException, Exception, JavaScriptException, NetworkConnectionException, coreApp, stringifyWithMask, errorToException} from "@wonder/core-core";
...
export class LoggerImpl implements Logger {
    ...
    exception(exception: Exception, extraInfo: {[key: string]: string | undefined}, action: string): void {
        ...
        if (exception instanceof NetworkConnectionException) {
            ...
            info["app_state"] = stringifyWithMask(coreApp.loggerConfig?.maskedKeywords || [], "***", coreApp.store.app.getState());
        } else {
